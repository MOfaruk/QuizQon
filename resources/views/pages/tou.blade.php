    ...
    <div class="container mb-5">
        <div class="row">
            <div class="col-md-8 mx-auto">            
                <h2 class="h1 text-center my-5">TERMS OF USE</h2>
            </div>
        </div>
        <div class="row text-left">
            <div class="col-md-8 mx-auto">
                ...
                <p>The operator of this website can be reached at&nbsp;quizqon@gmail.com</p>
            </div>
        </div>
    </div>
</section>
